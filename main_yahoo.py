...
from dataloader import YahooImplicitDataset,Interactions,DataLoader
...
from utils import merge_dict, _show_me_a_list_func
...
RANDOM_SEED_LIST = [811272,7539013,10198946,11859450,2137043,15426527,19749541,15033024,18688815,6421808,]
RATIO_LIST = [0.5]
'''
RANDOM_SEED_LIST = []
for i in range(10):
...
if __name__ == '__main__':
    ...
    for seed in RANDOM_SEED_LIST:
        ...
        for ratio in RATIO_LIST:
            print('ratio:', ratio)
            dataset = YahooImplicitDataset(
                dataset_path=global_config.DATASET_PATH + DATASET_PATH, seed=seed, ratio=ratio
            )
            best_perform = main(
